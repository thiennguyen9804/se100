...
import { valueFormatter, handleData} from './outbound_data';
...
const chartSetting = {
  ...
  series: [{ dataKey: 'amount', label: 'Số lượng đơn xuất theo tháng', valueFormatter }],
  height: 400,
  sx: {
...
export default function OutboundBarChart() {
